...
const file_identity_v1_identity_proto_rawDesc = "" +
	"\n" +
	"\x1aidentity/v1/identity.proto\x12\videntity.v1\"C\n" +
	...
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x12\n" +
	"\x04role\x18\x03 \x01(\tR\x04role2\xe0\x01\n" +
	...
	"\aGetUser\x12\x1b.identity.v1.GetUserRequest\x1a\x1c.identity.v1.GetUserResponseBAZ?github.com/adel-safin/go-payment/api/gen/identity/v1;identityv1b\x06proto3"
...
var file_identity_v1_identity_proto_depIdxs = []int32{
	...
	4, // 2: identity.v1.IdentityService.GetUser:input_type -> identity.v1.GetUserRequest
	...
	5, // 5: identity.v1.IdentityService.GetUser:output_type -> identity.v1.GetUserResponse
